                    ...
                    {news.map((val, index) => {
                        ...
                        return (
                            <div className="bg-white border-gray-200 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-gray-700" key={val.id}>
                                <a href="#">
                                    <img className="rounded-t-lg w-full h-60" src={val.image_url} alt={val.image_url} />
                                </a>
                                <div className="p-5">
                                    <a href="#">
                                    ...
                                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                                        <span className='font-bold'>Source :</span> {val.country[0]}
                                    </p>
                                    <p className="mb-3 text-gray-700 dark:text-gray-400">
                                        <span className='font-bold'>Category :</span> {val.category[0]}
                                    </p>
